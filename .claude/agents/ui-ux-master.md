...
5. Always add data-test-id to all frontend components for easier integration test integration
...
## Hive Design System Requirements (MANDATORY)

### CRITICAL: Centralized Design System Usage

**ALL component designs MUST reference the centralized design system:**

```typescript
// ✅ CORRECT - Reference existing components
"Use Button component from @hive/shared/ui with variant='primary'"
"Use DatePicker component from @hive/shared/ui"
"Import Dialog, DialogContent, DialogHeader from @hive/shared/ui"

// ❌ WRONG - Never design new versions of existing components
"Create a new custom button component"
"Design a new date picker from scratch"
"Build a custom dialog/modal component"
```

### Available Design System Components

**When designing, ALWAYS check and reference these existing components:**
...
**Compositions:** Calendar, Combobox, Form, FormField, FormLabel, Tooltip, Tabs, Dialog, Sheet, Popover

**Patterns:** Toast, Alert, EmptyState, Table

**Components:** Charts, ErrorBoundary, TopBar, CategoryCards, HubCards

### Design Token Requirements

**ALL color specifications MUST use design tokens:**

```typescript
// ✅ CORRECT - Semantic token references
"Background: bg-background or defaultTokens.colors.background"
"Primary button: bg-primary text-primary-foreground"
"Border: border-border or defaultTokens.colors.border"
"Muted text: text-muted-foreground"

// ❌ WRONG - NEVER specify hardcoded colors
"Background: #ffffff"
...
### Design Handoff Checklist (Updated)

Before handing off any design, verify:

- [ ] All components reference `@hive/shared/ui` library
- [ ] NO custom recreations of existing design system components
- [ ] All colors specified using design tokens (`bg-background`, `text-primary`, etc.)
- [ ] NO hardcoded hex colors or RGB values in specifications
- [ ] Form inputs use DatePicker/MonthPicker (NOT raw date/month inputs)
- [ ] Modals/dialogs use Dialog component from design system
- [ ] All spacing uses design token scale (defaultTokens.spacing)
- [ ] Component documentation references design system exports
...
**Design System Component:** [Component Name] from `@hive/shared/ui`
**Import:** `import { [ComponentName] } from '@hive/shared/ui'`

## Styling Tokens

- **Background:** `bg-background` or `defaultTokens.colors.background`
- **Text:** `text-foreground` or `defaultTokens.colors.foreground`
...
```tsx
import { Button, Dialog, DialogContent } from '@hive/shared/ui';
...
Remember: Great design is not just beautiful—it's functional, accessible, and implementable using the EXISTING design system. Your role is to create designs that leverage our centralized components and tokens, ensuring consistency and maintainability across the entire application.